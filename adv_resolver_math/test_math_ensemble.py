...
@pytest.mark.parametrize(
    "answers,expected",
    [(["x=5", "x = 5"], "x=5"), (["5", "five"], "5"), (["Error", "x=5"], "x=5")],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            [Solution("A", "x=5", "", 0.49), Solution("B", "5", "", 0.51)],
            "No consensus",
        ),
        ([Solution("A", "x=5", "", 0.4), Solution("B", "5", "", 0.3)], "No consensus"),
        (
            [Solution("A", "Invalid", "", 0.8), Solution("B", "x=5", "", 0.8)],
            "No consensus",
        ),
        ([Solution("A", "Error", "", 0.0), Solution("B", "Error", "", 0.0)], "Error"),
    ],
)
...
@pytest.mark.parametrize(
    "solutions,expected",
    [
        ([Solution("A", "x=5", "", 0.49), Solution("B", "5", "", 0.51)], "5"),
        (
            [
                Solution("A", "x=5", "", 0.8),
                Solution("B", "x = 5", "", 0.7),

...
def main():
    ...
    parser_rstar.add_argument(
        "--mcts-rounds", type=int, default=3, help="Number of MCTS rollout rounds"
    )
    parser_rstar.add_argument(
        "--evolution-rounds",
        type=int,
        default=2,
        help="Number of evolutionary iteration rounds",
    )
    parser_rstar.add_argument(
        "--weight-coherence",
        type=float,
        default=0.4,
        help="Weight for step coherence in reward",
    )
    parser_rstar.add_argument(
        "--weight-conceptual",
        type=float,
        default=0.3,
        help="Weight for conceptual consistency in reward",
    )
    parser_rstar.add_argument(
        "--weight-efficiency",
        type=float,
        default=0.3,
        help="Weight for computational efficiency in reward",
    )

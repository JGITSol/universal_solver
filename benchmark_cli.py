...
def run_benchmark(
    dataset_name, sample_size, solver_names=None, out_dir="showcase_results"
):
...
def main():
    ...
    parser.add_argument(
        "--dataset", type=str, choices=list_benchmark_datasets(), required=True
    )
    parser.add_argument("--sample-size", type=int, default=10)
    parser.add_argument(
        "--solvers", type=str, nargs="*", help="List of solvers to run (optional)"
    )
